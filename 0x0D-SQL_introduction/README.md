...
-   Ongoing project - started 07-12-2021, must end by 07-13-2021 (in about 10 hours) - you're done with  0% of tasks.
...
-   [Basic SQL statements: DDL and DML](https://intranet.hbtn.io/rltoken/ibCYnC9CDgZg5NQQvccBWw "Basic SQL statements: DDL and DML")  (_no need to read the _)
...
-   If the database  `hbtn_0c_0`  t exist, your script should not fail
-   You are not allowed to use the  `SELECT`  or  `SHOW`  statements
...
-   You are not allowed to use s id value, only the  `name`  field
-   The database name will be passed as an argument of the  `mysql`  command
...
-   t list rows without a  `name`  value
...
DonBobGeorgename`  = Bobname`  = Alexname`  = Johnname`  = doesndemandUse donDonWHERE`WhatWhatWhatPrivilegeschapter 